...
const MDXComponents = {
    ...
    hr: Hr,
    a: CustomLink,
    p: (props) => <Text as="p" my={3} fontSize="17px" mt={0} lineHeight="tall" {...props} />,
    ul: (props) => <Box as="ul" fontSize="17px" pt={2} pl={4} ml={2} {...props} />,
    ol: (props) => <Box as="ol" fontSize="17px" py={2} pl={4} ml={2} {...props} />,
    li: (props) => <Box as="li" fontSize="17px" pb={1} {...props} />,
    blockquote: Quote,
}
