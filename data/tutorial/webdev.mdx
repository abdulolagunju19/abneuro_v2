...
**Components/MDXComponents**: This component maps the markdown elements to react components, introducing new styles to the Markdown default element structure. For example, you can modify the <p> tag annd extend the style of the <p> tag.
